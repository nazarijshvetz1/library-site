...
function boundedTarget(value: string | string[] | undefined): "home" | "visits" | "teachers" | "acquisitions" | "textbooks" | "literature" {
  return value === "visits" || value === "teachers" || value === "acquisitions" || value === "textbooks" || value === "literature" ? value : "home";
}
