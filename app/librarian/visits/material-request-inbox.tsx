  ...
  return (
    <form className={styles.readyForm} onSubmit={submit}>
      ...
      {loading ? <p className={styles.empty}>Перевіряємо фактичні залишки…</p> : <>
        ...
        <p className={styles.authHelp}>Telegram-нагадування буде поставлено на 10 хвилин раніше за вибраний час. Прострочене нагадування після часу видачі не надсилатиметься.</p>
