...
type RequestRecord = {
  ...
  librarianNote: string; clarificationMessage: string; teacherReply?: string; rejectionReason: string; status: string; duplicateCount: number;
