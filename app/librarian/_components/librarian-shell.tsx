    ...
    <div className={`${styles.shell} ${telegramMiniApp ? styles.telegramMiniApp : ""}`}>
      <header className={styles.header}>
        ...
        <nav className={styles.utilityNav} aria-label="Службові посилання">
          ...
          <a href={librarianLiteratureHref(telegramMiniApp)} title="Єдина бібліотека. Художня та наукова література">
      ...
      <div className={styles.layout}>
        <aside className={styles.sidebar} aria-label="Головне меню кабінету бібліотекаря">
          ...
          <nav className={styles.sidebarUtilities} aria-label="Службові посилання кабінету">
            ...
            <a href={librarianLiteratureHref(telegramMiniApp)} title="Єдина бібліотека. Художня та наукова література"><SiteIcon name="catalog" size={15} /> Художня та наукова література</a>
        ...
        <div className={styles.drawerLayer}>
          ...
          >
            ...
            <div className={styles.drawerUtilities}>
              ...
              <a href={librarianLiteratureHref(telegramMiniApp)} title="Єдина бібліотека. Художня та наукова література"><SiteIcon name="catalog" size={16} /> Художня та наукова література</a>
