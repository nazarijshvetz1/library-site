    ...
    <div className={`${styles.shell} ${telegramMiniApp ? styles.telegramMiniApp : ""}`}>
      <header className={styles.header}>
        ...
        <nav className={styles.utilityNav} aria-label="Службові посилання">
          ...
          <a href="/reader/catalog"><SiteIcon name="catalog" size={16}/> Єдина бібліотека художньої та наукової літератури</a><a href={librarianLiteratureHref(telegramMiniApp)} title="Кабінет бібліотекаря — художня та наукова література">
            Художня та наукова література <SiteIcon name="catalog" size={16} />
          </a>
      ...
      <div className={styles.layout}>
        <aside className={styles.sidebar} aria-label="Головне меню кабінету бібліотекаря">
          ...
          <nav className={styles.sidebarUtilities} aria-label="Службові посилання кабінету">
            ...
            <a href="/reader/catalog"><SiteIcon name="catalog" size={16}/> Єдина бібліотека художньої та наукової літератури</a><a href={librarianLiteratureHref(telegramMiniApp)} title="Кабінет бібліотекаря — художня та наукова література"><SiteIcon name="catalog" size={15} /> Художня та наукова література</a>
        ...
        <div className={styles.drawerLayer}>
          ...
          >
            ...
            <div className={styles.drawerUtilities}>
              ...
              <a href="/reader/catalog"><SiteIcon name="catalog" size={16}/> Єдина бібліотека художньої та наукової літератури</a><a href={librarianLiteratureHref(telegramMiniApp)} title="Кабінет бібліотекаря — художня та наукова література"><SiteIcon name="catalog" size={16} /> Художня та наукова література</a>
