import {LITERATURE_TITLE} from "@/lib/literature-labels";
import {authorizeLibrarianApi} from "@/lib/librarian-api";
import LiteratureWorkspace from "./workspace";
export const dynamic="force-dynamic";
export const metadata={title:{absolute:LITERATURE_TITLE+" · Міжнародний ліцей МАУП"},robots:{index:false,follow:false}};
